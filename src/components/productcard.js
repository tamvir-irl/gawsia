export default function Home({ title, description, bg }) {
  ...
  return (
    <div className="w-11/12 min-h-[90%] bg-white rounded-2xl shadow p-6 flex flex-col items-center">
      <div className="w-2/3 aspect-square rounded-xl">
        <div className="w-full h-full overflow-hidden rounded-lg">
          <img
            src={bg}
            alt="Background"
            className="w-full h-full hover:scale-110 duration-200 rounded-lg hover:rounded-lg"
          />
        </div>
      </div>
